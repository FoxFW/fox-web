  This repository houses Github Page elements for FoxFW.

- Full user guide (index.html) - FoxFW setup, Sub-GHz tools, Fox ESP32 App
  Suite, all four firmware update methods, FAP Compiler
- FoxFW Web Installer (flasher.html) - flash FoxFW to a Flipper Zero
  straight from the browser
- Fox ESP32 Web Flasher (fox-esp32-flasher.html) - flash Fox ESP32
